...
class GrantDisbursementServiceTest {
    ...
    void setUp() {
        ...
        household2 = new Household("h2", List.of(member3,member4), Household.HouseholdType.HDB, 70000);

        household3 = new Household("h3", List.of(member5,member6), Household.HouseholdType.CONDOMINIUM, 300000);
