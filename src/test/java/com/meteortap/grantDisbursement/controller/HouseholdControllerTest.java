...
class HouseholdControllerTest {
    ...
    void setUp() {
        ...
        household3 = new Household("h3", List.of(member5,member6), Household.HouseholdType.CONDOMINIUM, 70000);
    ...
    void createHousehold() throws Exception {
        Household toPost = new Household(null, List.of(member1,member2), Household.HouseholdType.LANDED, 0);
